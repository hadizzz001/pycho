        ...
        >
            ...
            <div className="NewsletterSignupFooter">
                <h2 className="NewsletterSignupFooter_Heading br_text-2xl br_text-center myGray">
                    Receive Weekly Mental Health Tips For Free…
                </h2>
                    ...
                    >
                        <ul>
                            <li>
                                <a
                                    target="_blank"
                                    href="https://www.tiktok.com/@Psychocounseling"
                                    data-auto-id="true"
                            ...
                            <li>
                                <a
                                    target="_blank"
                                    href="https://www.instagram.com/Psychocounseling"
                                    data-auto-id="true"
                                    id="page-footer-http-www-instagram-com-bellroy-1"
                                >
                                    <svg
                        ...
                        <div className="text">
                            <div className="column mb-5"  >
                                <p className="question myGray">
                                    ...
                                    <span>
                                        Contact{" "}
                                        <a
                                            href="mailto:info@psychocounseling.online"
                                            data-auto-id="true"
                                            id="page-footer-mailto-support-bellroy-com-1"
                                            className='myGray'
                                        >
                                            info@psychocounseling.online
                                        </a>
                                    </span>
                                </p>
                            </div>
                            <div className="column">
                                <span className="copyright myGray">
                                    All rights reserved © {(new Date().getFullYear())} Psychocounseling
                                </span>
                            </div>
                        </div>
                    </div>
